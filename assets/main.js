$(document).ready(function() {
    ...
    $('#registrationForm').submit(async function(e)
    {
        ...
        const formData =
        {
            ...
            cliente_relacion_con_usuario: $('input[name="cliente_relacion_con_usuario"]:checked').val(),
            cliente_direccion_pais: $('#cliente_direccion_pais').val(),
            cliente_direccion_estado: $('#cliente_direccion_estado').val(),
            cliente_direccion_ciudad: $('#cliente_direccion_ciudad').val(),
            cliente_direccion_codigo_postal: $('#cliente_direccion_codigo_postal').val(),
            cliente_direccion1: $('#cliente_direccion1').val(),
            cliente_direccion2: $('#cliente_direccion2').val(),
